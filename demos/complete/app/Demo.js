...
define(["require", "exports", "esri/core/tsSupport/declareExtendsHelper", "esri/core/tsSupport/decorateHelper", "esri/WebMap", "esri/portal/Portal", "esri/portal/PortalQueryParams", "esri/core/accessorSupport/decorators", "esri/core/watchUtils", "esri/widgets/Widget", "esri/widgets/support/widget"], function (require, exports, __extends, __decorate, WebMap, Portal, PortalQueryParams, decorators_1, watchUtils_1, Widget, widget_1) {
    ...
    var Demo = /** @class */ (function (_super) {
        ...
        Demo.prototype.renderContent = function () {
            return (widget_1.tsx("div", { class: "demo-panel" },
                this.renderInfoCard(),
                this.renderCountdown()));
        };
        Demo.prototype.renderInfoCard = function () {
            var portalItem = this.active;
            return (widget_1.tsx("div", { class: CSS.details, key: "card" },
                widget_1.tsx("h1", { class: CSS.header }, portalItem.title),
                widget_1.tsx("div", { class: "demo-item" },
                ...
                widget_1.tsx("div", { class: "demo-item" },
                    ...
                    widget_1.tsx("div", { class: "demo-urls" }, this.renderIconLink("Item", "https://www.arcgis.com/home/item.html?id=" + portalItem.id)))));
        };
        Demo.prototype.renderIconLink = function (label, href) {
            return (widget_1.tsx("a", { class: "demo-link-item", href: href, target: "_blank" },
        ...
        Demo.prototype.renderCountdown = function () {
            ...
            return (widget_1.tsx("div", { class: "demo-countdown", key: "countdown" },
        ...
        __decorate([
            ...
            widget_1.renderable()
        ], Demo.prototype, "active", void 0);
        __decorate([
            decorators_1.property({ readOnly: true })
        ], Demo.prototype, "webMaps", void 0);
        __decorate([
